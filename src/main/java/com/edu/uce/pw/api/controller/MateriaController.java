...
public class MateriaController {
        ...
        public ResponseEntity<Materia> actualizar(@PathVariable Integer id, @RequestBody Materia mat) {
            mat.setId(id);
            this.iMateriaService.actualizar(mat);
            
            HttpHeaders cabeceraPut = new HttpHeaders();
            cabeceraPut.add("mensaje_239", "Corresponde a la actualización de un recurso");
            cabeceraPut.add("valor", "Materia actualizada parcialmente");
        ...
        public ResponseEntity<Materia> actualizarParcial(@RequestBody Materia mat, @PathVariable Integer id) {
            ...
            cabeceraPatch.add("valor", "Materia actualizada parcialmente");
            
            this.iMateriaService.actualizar(mat2);
            return new ResponseEntity<>(mat2, cabeceraPatch, 239);
        }
